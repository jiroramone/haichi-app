...
_today_str     = _today.strftime("%Y%m%d")       # 例: 20260620
_yesterday_str = _yesterday.strftime("%Y%m%d")   # 例: 20260619

GITHUB_CURR_FILENAME  = f"{_today_str}.csv"              # 例: 20260620.csv
GITHUB_PREV_FILENAME  = f"{_yesterday_str}.csv"          # 例: 20260619.csv
GITHUB_HANRO_FILENAME = f"{_today_str}Diao-Jiao.csv"     # 例: 20260620Diao-Jiao.csv
